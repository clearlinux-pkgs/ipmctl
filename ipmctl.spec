...
#
Name     : ipmctl
Version  : 02.00.00.3599
Release  : 30
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3599/ipmctl-02.00.00.3599.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3599/ipmctl-02.00.00.3599.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3599
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569592425
mkdir -p clr-build
pushd clr-build
