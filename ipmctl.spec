...
#
Name     : ipmctl
Version  : 01.00.00.3374
Release  : 10
URL      : https://github.com/intel/ipmctl/archive/v01.00.00.3374.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v01.00.00.3374.tar.gz
...
%prep
%setup -q -n ipmctl-01.00.00.3374
...
export LANG=C
export SOURCE_DATE_EPOCH=1543864739
mkdir -p clr-build
pushd clr-build
%cmake ..
