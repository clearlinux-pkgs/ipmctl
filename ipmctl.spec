...
#
Name     : ipmctl
Version  : 02.00.00.3474
Release  : 21
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3474/ipmctl-02.00.00.3474.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3474/ipmctl-02.00.00.3474.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3474
...
export LANG=C
export SOURCE_DATE_EPOCH=1556290837
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
