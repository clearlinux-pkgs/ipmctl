...
%prep
%setup -q -n ipmctl-01.00.00.3344
...
%files config
%defattr(-,root,root,-)
%config /usr/etc/logrotate.d/ipmctl.conf
...
%files man
%defattr(0644,root,root,0755)
/usr/share/man/man1/ipmctl-acknowledge-event.1.gz
...
/usr/share/man/man1/ipmctl-run-diagnostic.1.gz
