...
#
Name     : ipmctl
Version  : 02.00.00.3459
Release  : 18
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3459/ipmctl-02.00.00.3459.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3459/ipmctl-02.00.00.3459.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3459
...
export LANG=C
export SOURCE_DATE_EPOCH=1554217248
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
