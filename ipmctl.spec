...
#
Name     : ipmctl
Version  : 02.00.00.3593
Release  : 29
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3593/ipmctl-02.00.00.3593.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3593/ipmctl-02.00.00.3593.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3593
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568863373
mkdir -p clr-build
pushd clr-build
