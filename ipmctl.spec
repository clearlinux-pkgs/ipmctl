...
Release  : 17
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3446.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3446.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3446
...
export LANG=C
export SOURCE_DATE_EPOCH=1553651504
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
