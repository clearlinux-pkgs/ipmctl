...
#
Name     : ipmctl
Version  : 02.00.00.3609
Release  : 33
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3609/ipmctl-02.00.00.3609.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3609/ipmctl-02.00.00.3609.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3609
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570639975
mkdir -p clr-build
pushd clr-build
