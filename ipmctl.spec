...
#
Name     : ipmctl
Version  : 02.00.00.3602
Release  : 31
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3602/ipmctl-02.00.00.3602.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3602/ipmctl-02.00.00.3602.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3602
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569780115
mkdir -p clr-build
pushd clr-build
