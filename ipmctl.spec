...
#
Name     : ipmctl
Version  : 01.00.00.3380
Release  : 11
URL      : https://github.com/intel/ipmctl/archive/v01.00.00.3380.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v01.00.00.3380.tar.gz
...
%prep
%setup -q -n ipmctl-01.00.00.3380
...
export LANG=C
export SOURCE_DATE_EPOCH=1545508622
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
