...
#
Name     : ipmctl
Version  : 02.00.00.3542
Release  : 22
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3542/ipmctl-02.00.00.3542.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3542/ipmctl-02.00.00.3542.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3542
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563639852
mkdir -p clr-build
pushd clr-build
