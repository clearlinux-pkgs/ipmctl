...
#
Name     : ipmctl
Version  : 02.00.00.3823
Release  : 66
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3823/ipmctl-02.00.00.3823.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3823/ipmctl-02.00.00.3823.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3823
cd %{_builddir}/ipmctl-02.00.00.3823
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601488236
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ipmctl-02.00.00.3823/BaseTools/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/716291b5f2b61d3f09e8695d22dc8b539d8c9648
cp %{_builddir}/ipmctl-02.00.00.3823/BaseTools/Source/C/BrotliCompress/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3823/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/e21a52856139a98b41da616f662889335fb1eea4
cp %{_builddir}/ipmctl-02.00.00.3823/MdeModulePkg/Library/BrotliCustomDecompressLib/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3823/MdeModulePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3823/MdeModulePkg/Universal/RegularExpressionDxe/Oniguruma/COPYING %{buildroot}/usr/share/package-licenses/ipmctl/b0d64f0b0dd0585917fbead12758d45912c962ce
cp %{_builddir}/ipmctl-02.00.00.3823/MdePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3823/ShellPkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
pushd clr-build
%make_install
popd
