...
#
Name     : ipmctl
Version  : 02.00.00.3583
Release  : 26
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3583/ipmctl-02.00.00.3583.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3583/ipmctl-02.00.00.3583.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3583
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567640366
mkdir -p clr-build
pushd clr-build
