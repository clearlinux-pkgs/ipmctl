...
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3764/ipmctl-02.00.00.3764.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3764
cd %{_builddir}/ipmctl-02.00.00.3764
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588628000
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ipmctl-02.00.00.3764/BaseTools/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/716291b5f2b61d3f09e8695d22dc8b539d8c9648
cp %{_builddir}/ipmctl-02.00.00.3764/BaseTools/Source/C/BrotliCompress/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3764/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c2401e81d7dc4dd069167ad3a2c7dafeb0eef2e0
cp %{_builddir}/ipmctl-02.00.00.3764/MdeModulePkg/Library/BrotliCustomDecompressLib/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3764/MdeModulePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3764/MdeModulePkg/Universal/RegularExpressionDxe/Oniguruma/COPYING %{buildroot}/usr/share/package-licenses/ipmctl/b0d64f0b0dd0585917fbead12758d45912c962ce
cp %{_builddir}/ipmctl-02.00.00.3764/MdePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3764/ShellPkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
pushd clr-build
%make_install
popd
