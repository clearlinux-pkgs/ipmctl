...
#
Name     : ipmctl
Version  : 02.00.00.3607
Release  : 32
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3607/ipmctl-02.00.00.3607.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3607/ipmctl-02.00.00.3607.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3607
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570559558
mkdir -p clr-build
pushd clr-build
