...
cp %{_builddir}/ipmctl-02.00.00.3630/BaseTools/Source/C/BrotliCompress/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3630/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c2401e81d7dc4dd069167ad3a2c7dafeb0eef2e0
cp %{_builddir}/ipmctl-02.00.00.3630/MdeModulePkg/Library/BrotliCustomDecompressLib/LICENSE %{buildroot}/usr/share/package-licenses/ipmctl/c045813a6c514f2d30d60a07c6aaf3603850e608
cp %{_builddir}/ipmctl-02.00.00.3630/MdeModulePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3630/MdeModulePkg/Universal/RegularExpressionDxe/Oniguruma/COPYING %{buildroot}/usr/share/package-licenses/ipmctl/b0d64f0b0dd0585917fbead12758d45912c962ce
cp %{_builddir}/ipmctl-02.00.00.3630/MdePkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
cp %{_builddir}/ipmctl-02.00.00.3630/ShellPkg/License.txt %{buildroot}/usr/share/package-licenses/ipmctl/302141e29032602914e0d986c783ff1c83619b10
pushd clr-build
%make_install
popd
