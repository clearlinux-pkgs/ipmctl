...
#
Name     : ipmctl
Version  : 02.00.00.3423
Release  : 15
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3423.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3423.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3423
...
export LANG=C
export SOURCE_DATE_EPOCH=1550423131
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
