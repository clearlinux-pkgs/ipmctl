...
#
Name     : ipmctl
Version  : 02.00.00.3439
Release  : 16
URL      : https://github.com/intel/ipmctl/archive/v02.00.00.3439.tar.gz
Source0  : https://github.com/intel/ipmctl/archive/v02.00.00.3439.tar.gz
...
%prep
%setup -q -n ipmctl-02.00.00.3439
...
export LANG=C
export SOURCE_DATE_EPOCH=1552411035
mkdir -p clr-build
pushd clr-build
